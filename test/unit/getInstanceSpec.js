describe('getInstance function Spec', function () {
	...
	describe('function logEnabled Spec', function () {
		it('should expect global debug flag to be enabled', function () {
			$log.enableLog(true);
			expect($log.logEnabled()).toBeTruthy();
		});

		it('should expect global debug flag to be not be enabled when verbose is set to true', function () {
			$log.enableLog(true, true);
			expect($log.logEnabled()).toBeFalsy();
		});

		it('should expect global debug flag to be not be enabled when verbose & debug are both false', function () {
			$log.enableLog(false, false);
			expect($log.logEnabled()).toBeFalsy();
		});
	});
